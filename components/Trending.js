    ...
    <div className="hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Tech Industry</h1>
          <p className="text-xs text-gray-500">204K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Boeing</h1>
          <p className="text-xs text-gray-500">180K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Hollywood</h1>
          <p className="text-xs text-gray-500">144K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">Egypt</h1>
          <p className="text-xs text-gray-500">82K Tweets</p>
        </div>
      </div>
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            ...
            <div>
              ...
              <h1 className="text-[12px] mt-1 text-gray-500">@kylie100k</h1>
            </div>
          </div>
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            ...
            <div>
              ...
              <h1 className="text-[12px] mt-1 text-gray-500">@realElon</h1>
            </div>
          </div>
